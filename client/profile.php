...
<section class="profile-card-layout">
  <article class="profile-card-demo profile-card-live profile-card-compact">
    ...
    <p class="profile-card-demo__bio"><?= lex_e(trim($address !== '' ? $address : 'Client account details')) ?></p>
    ...
    <section class="profile-card-demo__info" aria-label="Client details">
      ...
      <div class="profile-card-demo__row">
        ...
        <div class="profile-card-demo__row-body">
          ...
          <strong class="profile-card-demo__row-value"><?= lex_e($contactNumber) ?></strong>
        </div>
      </div>
    </section>
    <div class="profile-card-demo__actions">
      <a class="button button-primary" href="<?= lex_e(lex_app_url('client/messages.php')) ?>">Contact</a>
  ...
  <div class="modal-card wide profile-edit-modal" role="dialog" aria-modal="true" aria-labelledby="profileEditTitle">
    <div class="modal-header">
      <div>
        ...
        <p class="modal-note">Update your account details, password, and profile avatar.</p>
      </div>
