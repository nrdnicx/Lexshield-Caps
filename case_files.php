...
function lex_case_files_render_pagination(array $state): string
{
    ...
    $info = $total > 0
        ? 'Showing ' . number_format($start) . '&ndash;' . number_format($end) . ' of ' . number_format($total)
        : 'No results';
      ...
      <div class="case-vault-topbar case-vault-overview">
        <div class="case-vault-heading">
          <div class="case-vault-identity">
            <span class="case-vault-avatar"><?= lex_e(lex_case_files_client_initials((string) $record['full_name'])) ?></span>
            <div class="case-vault-identity-copy">
              <h3><?= lex_e((string) $record['full_name']) ?></h3>
...
<div id="case-files-summary" data-case-summary-container>
  ...
  <form method="get" class="case-search-bar" data-case-filter-form data-no-loading novalidate>
    ...
    <label class="case-search-field case-search-field-wide">
      <span>Search</span>
